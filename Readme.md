...
2.	Ana Luzardo:  Soy Venezolana, casada, Bioanalista/Bioquímico de profesión. Desde 2020 me adentré en el mundo de la programación, comenzando por HTML, CSS y JavaScript y encontrando una fuerte afinidad con el área de Frontend. En Argentina trabajé en administración, pero actualmente estoy enfocada en avanzar de manera más sólida en el desarrollo web. Con este curso de Digital House pude profundizar muchísimo más en JavaScript y además conocer la parte de backend, ampliando mi formación y mi camino hacia convertirme en desarrolladora Full Stack.
